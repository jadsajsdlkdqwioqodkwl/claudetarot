...
const ICONS = {
  ...
  install: `<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M10 3v9M6 8.5l4 4 4-4"/><path d="M3.5 13.5v2a1 1 0 001 1h11a1 1 0 001-1v-2"/></svg>`,
  pencil:`<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12.5 3.5l4 4L6 18l-4.3.8L2.5 14.5z"/><path d="M11 5l4 4"/></svg>`,
